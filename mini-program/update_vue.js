...
const vueContent = fs.readFileSync('/Users/zhugehao/muying-ai-app/mini-program/src/pages/calendar/index.vue', 'utf8');

const updatedVueContent = vueContent.replace(
  /const mockDbData = \[\s*\{[\s\S]*?\}\s*\]\n/,
  `const mockDbData = ${JSON.stringify(mockDataArray, null, 2)};\n`
);

fs.writeFileSync('/Users/zhugehao/muying-ai-app/mini-program/src/pages/calendar/index.vue', updatedVueContent);
console.log('Vue file updated with full mock data!');
