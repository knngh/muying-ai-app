...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  {
    id: 'care', title: '喂养三件套', kicker: '新生儿照护', description: '记录喂奶、尿布和睡眠，整理每日照护交接单。', icon: '护', group: 'baby', tone: 'green', status: 'preview',
    stages: ['newborn', 'feeding'], primaryAction: '记一笔照护', helper: '支持计时恢复、补记和交接单预览复制。',
  },
  {
