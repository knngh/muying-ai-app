...
export function buildSafeArticleHtml(content: string): string {
  ...
  return `<html><head><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"><style>html,body{padding:0;margin:0;background:#FFF9F4;overflow-x:hidden}body{font-size:16px;line-height:1.9;color:#35261E;word-break:break-word;overflow-wrap:anywhere;text-align:justify;text-justify:inter-ideograph;text-align-last:left;-webkit-hyphens:auto;hyphens:auto}*{box-sizing:border-box}p,li,div,section,article{color:#70554A;text-align:justify;text-justify:inter-ideograph;text-align-last:left;word-break:break-word;overflow-wrap:anywhere}p{margin:0 0 1.1em}ul,ol{padding-left:1.2em;margin:0 0 1.1em}li+li{margin-top:.45em}img,svg,video{display:block;max-width:100%!important;height:auto!important;border-radius:16px;margin:12px 0}a{color:#9F4E2E;text-decoration:none;word-break:break-all}h1,h2,h3,h4,h5,h6{color:#241813;line-height:1.45;margin:0 0 0.8em;text-align:left}blockquote{margin:16px 0;padding:12px 16px;border-left:4px solid #D98A5D;background:#F8EBDD;border-radius:12px;color:#70554A;text-align:justify;text-align-last:left}figcaption{margin:-4px 0 14px;color:#7D6C61;font-size:13px;line-height:1.7;text-align:left}pre,code{white-space:pre-wrap;word-break:break-word}pre{background:#FFF4EA;border-radius:14px;padding:12px;overflow-x:auto;text-align:left}table{width:max-content;min-width:100%;max-width:none!important;border-collapse:collapse;background:#fff7f1;font-size:13px;line-height:1.6}th,td{min-width:96px;border:1px solid rgba(184,138,72,0.18);padding:10px 12px;vertical-align:top;text-align:left;white-space:normal}th{background:#F8EBDD;color:#35261E;font-weight:700}.article-table-wrap{width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;margin:16px 0;padding-bottom:4px;border:1px solid rgba(184,138,72,0.12);border-radius:16px;background:#fffdf9}.article-table-wrap table{max-width:none!important}hr{border:none;border-top:1px solid rgba(184,138,72,0.16);margin:18px 0}</style></head><body>${safeContent}</body></html>`
}
