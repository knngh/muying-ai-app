...
const GLOSSARY: GlossaryEntry[] = [
  ...
  { terms: ['假宫缩', '假性宫缩'], expansions: ['braxton hicks contractions', 'false labor', 'practice contractions'] },
  { terms: ['规律宫缩', '阵痛'], expansions: ['regular contractions', 'true labor'] },
  { terms: ['临产', '待产', '分娩征兆'], expansions: ['labor signs', 'true labor', 'birth preparation'] },
  { terms: ['胎动'], expansions: ['fetal movement', 'baby movement', 'kicks'] },
  { terms: ['胎动减少', '胎动变少', '胎动少', '胎动异常', '胎动频繁'], expansions: ['decreased fetal movement', 'reduced fetal movement', 'fetal movement changes', 'kick count', 'counting kicks'] },
  ...
  { terms: ['配方奶', '奶粉', '冲奶', '奶瓶'], expansions: ['formula', 'formula milk', 'baby formula', 'powdered formula', 'bottle feeding'] },
  ...
  { terms: ['吐奶', '溢奶', '拍嗝', '反流'], expansions: ['spit up', 'spit-up', 'spitting up', 'burping', 'hiccups'] },
  { terms: ['鱼肝油', '维生素D', '维生素d', '维d', '维D'], expansions: ['vitamin d', 'vitamin d supplements', 'cod liver oil'] },
  { terms: ['翻身', '坐不稳', '不会坐', '扶站', '不会站', '不会伸手', '伸手拿东西', '不会逗笑', '逗笑', '抬头', '爬行', '抓握', '大运动', '精细动作'], expansions: ['development', 'milestone', 'milestones', 'developmental milestones', 'motor milestones', 'movement milestones', 'developmental screening'] },
