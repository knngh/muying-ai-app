...
const PERSONAL_BIRTH_DECISION_PATTERN = /(?:过预产期|胎儿.{0,12}入盆|还没有入盆|脐带(?:绕(?:脖子|颈)|缠绕)|剖腹产|剖宫产|开刀生产|带状疱疹).{0,60}(?:顺产|剖腹|刨腹|分娩方式|选择|还要不要.{0,8}检查|多久才生|可以么|可以吗|能不能)|(?:顺产|剖腹|刨腹|分娩方式|多久才生).{0,60}(?:过预产期|入盆|脐带|开刀生产|剖腹产|剖宫产|带状疱疹)|(?:室间隔缺损|先心病).{0,60}(?:怀孕|手术|生产之前)|(?:羊水.{0,12}偏多|心脏.{0,12}(?:亮光|有问题)|肚子里面的宝宝心脏|侧脑室宽|脊椎看不见).{0,60}(?:怎么办|怎么回事|控制|检查|正常吗|有事|问题|影响)/u;
...
const ADULT_REPRODUCTIVE_CASE_PATTERN = /(?:月经|大姨妈|房事|同房|性生活|紧急避孕药|安全期|宫颈(?:糜|靡)烂|利普刀|尿血|血块|膀胱下坠|尿急尿痛|妇科病|阴道炎).{0,36}(?:怀孕|宝宝|孩子|小孩|怎么办|什么原因|影响)|(?:男性|男方|丈夫|老公).{0,18}(?:发烧|打针|吃药|用药|接种).{0,24}(?:性生活|怀孕|胎儿|宝宝)|(?:生完(?:小孩|孩子|宝宝)|生宝宝|产后|断奶后).{0,60}(?:会阴撕裂|宫颈(?:糜|靡)烂|宫颈.{0,6}充血|利普刀|月经|月子病|关节疼痛|下面.{0,12}(?:有血|出血|流血)|乳房.{0,12}(?:一变大一变小|明显|大小不一)|尿血|膀胱下坠)|流产后.{0,80}(?:腰|膝|坐骨|神经|麻痹|风湿)|孩子.{0,8}两岁.{0,36}(?:体重|胖|170斤)|(?:性生活|同房).{0,24}(?:怀孕|胎儿|宝宝|影响)/u;

const EMERGENCY_OR_POISONING_CASE_PATTERN = /(?:水银|纽扣电池|异物|颗粒|硬币).{0,20}(?:吃了|吞了|入口|进嘴|误食|误吞)|(?:呼吸困难|喘气不匀|昏睡|抽搐|抽风|窒息).{0,24}(?:宝宝|孩子|小孩|婴儿|新生儿|预防针|接种)|(?:宝宝|孩子|小孩|婴儿|新生儿).{0,24}(?:呼吸困难|喘气不匀|昏睡|抽搐|抽风|窒息)|(?:接种|疫苗|预防针|白百破|流感嗜血杆菌).{0,40}(?:嗜睡|没精神|急急急)|(?:嗜睡|没精神|急急急).{0,40}(?:接种|疫苗|预防针|白百破|流感嗜血杆菌)|(?:高烧|发高烧).{0,40}(?:呕吐|腹泻|嗜睡)|(?:食物中毒|野生菌).{0,60}(?:怀孕|孕|胎儿|腹痛|腹泻|呕吐|治疗)|(?:怀孕|孕).{0,40}(?:强烈撞击|撞击肚子|外伤).{0,40}(?:感觉不到胎动|胎动.{0,12}(?:没有|减少)|宝宝会不会出问题)|(?:颗粒|戒指|异物|木头).{0,24}(?:进嘴|入口|吃掉|吞|取出来)|(?:猫抓|狗咬|犬咬|抓伤).{0,40}(?:宝宝|孩子|小孩|女儿|儿子|打针|没打针|怕吗)|(?:发热|发烧).{0,8}39度.{0,24}(?:疫苗|接种|注射|怎么治|宝宝|孩子)|(?:接种|疫苗|预防针|百白破|脊灰).{0,50}(?:流鼻血|鼻血)|(?:孩子|宝宝|小孩).{0,20}(?:疼起来|疼得|特别厉害|使劲哭)/u;
