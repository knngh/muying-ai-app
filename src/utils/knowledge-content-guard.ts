...
const ADULT_DERMATOLOGY_CASE_PATTERN = /(?:我的脚|脚气|涂料厂上班|手指.{0,12}(?:水疱|开裂|皮肤变硬)).{0,40}(?:湿疹|皮肤|水疱|脚气)|(?:湿疹|皮肤|水疱|脚气).{0,40}(?:我的脚|脚气|涂料厂上班|手指.{0,12}(?:水疱|开裂|皮肤变硬))/u;
...
const PERSONAL_TREATMENT_REQUEST_PATTERN = /(?:用|抹|涂|吃|服用|注射).{0,10}(?:药|药膏|康瑞保|美皮护|抗生素|消炎药|退烧药|针剂).{0,12}(?:有用|管用|可以|行吗|能用|能吃)|(?:用|抹|涂|擦|吃|服用|服|喝).{0,8}(?:什么|哪种|哪类|哪两种|啥|什么样的).{0,6}(?:药|药膏|软膏|中成药|西药|抗生素|消炎药|退烧药)|(?:用|抹|涂|擦|吃|服用|注射).{0,16}(?:行么|行吗|可以吗|能吗|能不能).{0,16}(?:湿疹|黄疸|腹泻|发烧|咳嗽|疫苗|药)|(?:什么|哪种|哪类|哪两种).{0,10}(?:药|药膏|软膏).{0,12}(?:治|治疗|擦|抹|效果|配合)|(?:茵栀黄|妈咪爱|思密达|腹泻奶粉|琥珀抱龙丸|护脑针|抗病毒合剂|消炎药|感冒冲剂|双黄消炎片|利君沙).{0,24}(?:可以|能|还要|是不是|是否|影响|多久|多长|怎么办|怎么回事|适合|更适合|需要|吃多了|会(?:降|好))|(?:药(?!店)|药膏|软膏|中成药|西药).{0,12}(?:效果好|最好|更适合)|(?:请专家)?帮(?:我)?配药|(?:如何|怎么|怎样).{0,8}(?:治疗|用药)|(?:应如何|怎么).{0,8}治疗/u;

const SPECIFIC_PRODUCT_OR_EXPOSURE_RISK_PATTERN = /(?:贝特晓芙|叶酸铁钙片|复方葡萄糖酸钙|铁之缘|鹿角|止疼片|阿莫西林|妥布霉素|滴眼液|眼药水|双黄消炎片|避孕药).{0,36}(?:可以|能不能|能用|能吃|是否|影响|有影响|怎么样|怎么回事|怎么办|怎莫办|继续|口服|吃了|用了)|(?:可以|能不能|能用|能吃|是否|影响|有影响|怎么样|怎么办|怎莫办|继续|口服|吃了|用了).{0,36}(?:贝特晓芙|叶酸铁钙片|复方葡萄糖酸钙|铁之缘|鹿角|止疼片|阿莫西林|妥布霉素|滴眼液|眼药水|双黄消炎片|避孕药)|(?:CT|ct|胸透|拍片子?|做了ct|肺部ct).{0,40}(?:怀孕|宝宝|孩子|小孩|母乳|吃奶|哺乳|要小孩|要孩子|有影响|影响|多久)|(?:怀孕|宝宝|孩子|小孩|母乳|吃奶|哺乳|要小孩|要孩子).{0,40}(?:CT|ct|胸透|拍片子?|做了ct|肺部ct).{0,30}(?:影响|多久|可以|能不能)/u;

const DIAGNOSED_CASE_FOLLOWUP_PATTERN = /(?:去医院检查|医院检查|检查了|检查说|医生说|诊断为|确诊为|患有|得了).{0,30}(?:支气管哮喘|脑桥小脑角综合征|脑积水|白癜风|白癫风|胆囊癌|肿瘤|癌|综合征|罕见病|发育迟缓|脑室|侧脑室|颅后窝池|颅骨骨折|鼻漏|肾.{0,8}(?:囊肿|发育不正常)|巨型输尿管|心内膜垫缺损|二尖瓣反流|三尖瓣反流|风疹综合症)|(?:医生建议|配合治疗|治疗方案|复查结果|检查结果|核磁共振|磁共振|脑电图|心脏彩超).{0,30}(?:治疗|用药|手术|康复|多久|饮食习惯|注意事项)|(?:重型手足口病|脑炎|颅骨骨折|鼻漏|运动神经发育迟缓|第三脑室|巨型输尿管|肾.{0,8}(?:囊肿|发育不正常)|心内膜垫缺损|风疹综合症|羊水过多|抽脐带血).{0,36}(?:怎么办|治疗|康复|影响|生活能行|严重吗|检查|什么时候|手术|后遗症|必要|还用|需要)|(?:CT|ct|24小时脑电图|脑电图|核磁共振|磁共振|心脏彩超).{0,80}(?:没查出|没查出来|更详细的检查|详细的检查|能治疗|治疗吗|复查|严重吗)|(?:左脑发育不太好|精神发育迟缓|智力达不到同龄|晕厥了几次).{0,80}(?:检查|治疗|没查出|原因)|(?:霰粒肿|白癜风|白癫风).{0,80}(?:医生说|治了|治疗|复发|等到|手术|怎么办|我该怎么办)|(?:抽脐带血|脐带血穿刺).{0,36}(?:必要|还用|需要|影响|风险|检查)/u;
...
const ADULT_REPRODUCTIVE_CASE_PATTERN = /(?:月经|大姨妈|房事|同房|性生活|紧急避孕药|安全期|宫颈(?:糜|靡)烂|利普刀|尿血|血块|膀胱下坠|尿急尿痛|妇科病).{0,36}(?:怀孕|宝宝|孩子|小孩|怎么办|什么原因|影响)|(?:男性|男方|丈夫|老公).{0,18}(?:发烧|打针|吃药|用药|接种).{0,24}(?:性生活|怀孕|胎儿|宝宝)|(?:生完(?:小孩|孩子|宝宝)|生宝宝|产后|断奶后).{0,60}(?:会阴撕裂|宫颈(?:糜|靡)烂|宫颈.{0,6}充血|利普刀|月经|下面.{0,12}(?:有血|出血|流血)|乳房.{0,12}(?:一变大一变小|明显|大小不一)|尿血|膀胱下坠)|(?:性生活|同房).{0,24}(?:怀孕|胎儿|宝宝|影响)/u;

const EMERGENCY_OR_POISONING_CASE_PATTERN = /(?:水银|纽扣电池|异物|颗粒|硬币).{0,20}(?:吃了|吞了|入口|进嘴|误食|误吞)|(?:呼吸困难|喘气不匀|昏睡|抽搐|抽风|窒息).{0,24}(?:宝宝|孩子|小孩|婴儿|新生儿|预防针|接种)|(?:宝宝|孩子|小孩|婴儿|新生儿).{0,24}(?:呼吸困难|喘气不匀|昏睡|抽搐|抽风|窒息)|(?:接种|疫苗|预防针|白百破|流感嗜血杆菌).{0,40}(?:嗜睡|没精神|急急急)|(?:嗜睡|没精神|急急急).{0,40}(?:接种|疫苗|预防针|白百破|流感嗜血杆菌)|(?:高烧|发高烧).{0,40}(?:呕吐|腹泻|嗜睡)/u;
...
export function getDatasetKnowledgeDropReason(record: KnowledgeGuardRecord): string | null {
  ...
  if (PERSONAL_TREATMENT_REQUEST_PATTERN.test(question) || SPECIFIC_PRODUCT_OR_EXPOSURE_RISK_PATTERN.test(question)) {
