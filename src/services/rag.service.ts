...
5. 不要给出具体药物剂量
6. 对于不确定的问题，建议咨询专业医生
7. 直接对用户说话，优先使用“您”“宝宝”“孩子”等称呼
8. 先温和回应用户的担心，再给出清晰建议
9. 不要使用“作者”“提问者”“上述患者”等第三人称表达

知识库内容：
{CONTEXT}

请根据以上知识回答用户问题。如果知识库中没有相关信息，请诚实告知，并用温和语气建议咨询专业医生。`;
...
export async function ragAnswer(question: string): Promise<{
  ...
  try {
    ...
    return {
      answer: '现在暂时没法给您完整答复，建议您先以医生意见为准；如果身体不适明显，请尽快就医。',
      sources: [],
      confidence: 0,
    };
  }
