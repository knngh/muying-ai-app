...
// A = top international authorities (WHO/CDC/AAP/ACOG/NHS/NIH/FDA/Mayo/MSD)
...
export const AUTHORITY_SOURCES: AuthoritySourceConfig[] = [
  ...
  },
  {
    ...
    parserId: 'generic-english',
    qualityTier: 'A',
  },
  {
    id: 'nichd',
    org: 'NICHD',
    baseUrl: 'https://www.nichd.nih.gov',
    allowedDomains: ['nichd.nih.gov', 'www.nichd.nih.gov'],
    discoveryType: 'index_page',
    entryUrls: [
      'https://www.nichd.nih.gov/health/topics/pregnancy',
      'https://www.nichd.nih.gov/health/topics/breastfeeding',
      'https://www.nichd.nih.gov/health/topics/infantcare',
    ...
    language: 'en',
    locale: 'en-US',
    audience: ['孕妇', '新生儿家长', '婴幼儿家长', '备孕家庭'],
    topics: ['pregnancy', 'newborn', 'feeding', 'development', 'common-symptoms'],
    enabled: false,
    fetchIntervalMinutes: 360,
    maxPagesPerRun: 160,
    maxDiscoveryIndexPages: 8,
  ...
  {
    id: 'fda-women-health',
    org: "FDA Office of Women's Health",
    baseUrl: 'https://www.fda.gov',
    allowedDomains: ['fda.gov', 'www.fda.gov'],
    discoveryType: 'index_page',
    entryUrls: [
      'https://www.fda.gov/consumers/womens-health-topics/pregnancy',
      'https://www.fda.gov/consumers/womens-health-topics/breastfeeding',
    ],
    region: 'US',
    language: 'en',
    locale: 'en-US',
    audience: ['孕妇', '产后妈妈', '新生儿家长'],
  ...
  },
  {
    ...
    allowedDomains: ['ncbi.nlm.nih.gov', 'www.ncbi.nlm.nih.gov'],
    discoveryType: 'index_page',
    entryUrls: [
    ...
    locale: 'en-US',
    audience: ['产后妈妈', '新生儿家长'],
    topics: ['feeding', 'pregnancy', 'common-symptoms'],
    enabled: true,
