...
- 使用生产 QA 快照 `/tmp/muying-prod-expanded-qa-data-5000.enriched.json` 和当前 guard 口径审计，权威覆盖率为 `80.63%`（`1428/1771`，缺口 `343`），已超过 P3 `80%+` 目标。
...
2026-05-13 P3-35 切片：继续收紧覆盖分母中的低质个案，新增成人疫苗 / 狂犬疫苗非母婴场景、甲醛暴露检测补救、遗传 / 乙肝“能不能生 / 要孩子”高敏决策、结构化低信息病例表单，以及更窄的具体用药选择识别；普通乙肝孕前检查与母婴阻断科普、宝宝湿疹护理等保留。本地审计分母从 `2482` 收至 `2447`，缺口从 `1204` 收至 `1179`，覆盖率从 `51.49%` 升至 `51.82%`。

2026-05-13 P3-36 切片：继续收紧具体药品 / 产品治疗诉求、成人职业性皮肤病误入母婴分母，以及接种后伴嗜睡 / 没精神 / 明确急迫表达的高风险个案；普通接种后局部红肿、宝宝湿疹护理等一般科普继续保留。本地审计分母从 `2447` 收至 `2415`，缺口从 `1179` 收至 `1154`，覆盖率从 `51.82%` 升至 `52.22%`。

2026-05-13 P3-37 切片：继续收紧产前影像 / 胎儿生物测量 / 侵入性检查决策类个案，双顶径、股骨长、羊水量、S/D 值等带个人顺产判断或处理诉求的问句不再进入自动覆盖目标；“是否继续留下孩子”高敏决策，以及先天性风疹综合症、心内膜垫缺损、羊水过多抽脐带血等确诊 / 检查随访问题也分流出推广分母；一般产检 / B 超科普仍保留。本地审计分母从 `2415` 收至 `2393`，缺口从 `1154` 收至 `1139`，覆盖率从 `52.22%` 升至 `52.4%`。

2026-05-14 P3-38 切片：继续收紧具体药品 / 保健品 / 外用产品和放射检查暴露后的个人风险追问，贝特晓芙叶酸铁钙片、双黄消炎片、复方葡萄糖酸钙、铁之缘、鹿角外敷、止疼片 / 阿莫西林、CT / 拍片后多久要小孩或是否影响哺乳等记录不再进入自动覆盖目标；普通孕期 / 哺乳期用药安全科普仍保留。本地审计分母从 `2393` 收至 `2356`，缺口从 `1139` 收至 `1114`，覆盖率从 `52.4%` 升至 `52.72%`。

2026-05-14 P3-39 切片：继续收紧已检查 / 已诊断后的个人随访个案，磁共振 / 脑电提示发育迟缓后追问更详细检查或治疗、霰粒肿医生建议随访后追问、反复晕厥已做 CT / 脑电 / 核磁 / 心超仍未查出原因、白癫风治疗后疑复发等记录不再进入自动覆盖目标；普通发育照护和一般黄疸 / 湿疹科普仍保留。本地审计分母从 `2356` 收至 `2349`，缺口从 `1114` 收至 `1107`，覆盖率从 `52.72%` 升至 `52.87%`。

2026-05-14 P3-40 切片：继续收紧产后成人个案分母，生宝宝后会阴撕裂伤口复查仍疼、产后数月下面反复有血并伴宫颈充血等记录不再进入自动覆盖目标；“产后恶露如何观察、什么时候需要就医”这类一般恢复科普仍保留。本地审计分母从 `2349` 收至 `2347`，缺口从 `1107` 收至 `1105`，覆盖率从 `52.87%` 升至 `52.92%`。

2026-05-14 P3-41 批处理：按当前 remediation queue 继续批量收紧明显不适合自动权威覆盖 / 推广的个案，包括疫苗价格和防疫站费用咨询、个人用药 / 输液 / 麻药 / 米酒 / 红外线贴膏药暴露风险、产后成人错类和流产后成人疼痛、分娩方式与胎儿异常个人决策、急症误食 / 猫抓 / 强烈撞击后胎动消失 / 疫苗后鼻血或 39 度发热，以及胎儿问题误入育儿分类。保留一般孕期用药安全、产后恶露观察、宝宝发热和接种后普通局部反应科普。本地审计分母从 `2347` 收至 `2146`，缺口从 `1105` 收至 `987`，覆盖率从 `52.92%` 升至 `54.01%`。

2026-05-14 P3-42 批处理：继续按 remediation queue 收紧不适合自动覆盖 / 推广的个人化个案，包括先兆流产伴孕囊 / 胚芽异常追问、血常规嗜酸性粒细胞超高后的饮食限制、肾炎指标合并妊娠生产判断、胎儿鼻骨缺失 / 染色体结果追问、ABO 溶血和地中海贫血个案、误服胶囊 / 高血项反复发热 / 新生儿呼吸不畅或高烧等急症、具体补钙 / 避孕药 / 阿托品 / 外用偏方和婴儿洗护产品选择、四维 / 胎儿心脏彩超能力或预约类问题，以及 BPD / HC / FL / AC / 羊水 / 股骨长等个人测量解释和顺产判断。保留胎动计数、产后心理健康、吐奶护理、湿疹护理等一般科普入口。本地审计分母从 `2146` 收至 `1961`，缺口从 `987` 收至 `872`，覆盖率从 `54.01%` 升至 `55.53%`。
...
38. P3-35 已完成低质个案继续收口：成人疫苗 / 狂犬疫苗非母婴场景、甲醛暴露检测补救、遗传 / 乙肝生育高敏决策、低信息病例表单和具体用药选择不再进入自动权威覆盖目标。
39. P3-36 已完成具体药品 / 产品治疗诉求和高风险接种后个案收口：茵栀黄 / 妈咪爱 / 腹泻奶粉 / 护脑针等具体用药效果或选择题、成人职业性皮肤病，以及接种后嗜睡 / 没精神 / 急迫个案不再进入自动覆盖目标。
40. P3-37 已完成产前影像 / 生物测量 / 检查决策个案收口：带个人顺产判断、胎儿测量解释、是否继续妊娠、先天性风疹综合症 / 心内膜垫缺损随访、羊水过多抽脐带血决策的记录不再进入自动覆盖目标；一般产检和 B 超科普继续保留。
41. P3-38 已完成具体产品和检查暴露风险追问收口：特定保健品 / 药品 / 外用产品、哺乳期已用药影响、CT / 拍片后要孩子或喂奶影响等个人风险判断题不再进入自动覆盖目标；一般孕期和哺乳期用药安全科普继续保留。
42. P3-39 已完成已检查 / 已诊断后个人随访个案收口：发育迟缓影像脑电结果后追问检查治疗、霰粒肿随访时点追问、反复晕厥多项检查后仍追问原因，以及白癫风治疗后疑复发等记录不再进入自动覆盖目标；一般发育和常见照护科普继续保留。
43. P3-40 已完成产后成人个案继续收口：会阴撕裂复查后持续疼痛、产后数月反复出血 / 宫颈充血等个人诊断追问不再进入自动覆盖目标；产后恶露观察等一般科普继续保留。
