...
Env:
  ...
  AUTHORITY_SOURCE_DRY_RUN_SAMPLE_LIMIT default: 10; sample URL count per probed source
EOF
}
...
AUTHORITY_SOURCE_DRY_RUN_SAMPLE_LIMIT="${AUTHORITY_SOURCE_DRY_RUN_SAMPLE_LIMIT:-10}"
